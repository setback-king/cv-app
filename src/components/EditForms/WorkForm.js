   ...
   */
    ...
    return (
      <div>
        ...
        {workInfo.length === 0 ? (
          <button className="addBack" onClick={add}>
            Add
          </button>
        ) : null}
        {workInfo.map((item, index) => {
          return (
            <div key={item.key} className="form">
              <input
                type="text"
                id={item.key}
                name="dateBegin"
                ...
                onChange={(e) =>
                  changeWork(e.target.name, e.target.value, e.target.id)
                }
              />
              <input
                type="text"
              ...
              <div className="buttons">
                <button
                  ...
                  name="work"
                  onClick={(e) =>
                    deleteEntry(e.target.id, e.currentTarget.name)
                  }
                >
                  Delete
                </button>
