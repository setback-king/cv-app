  ...
  constructor(props){
    ...
    this.state = {
      general: {
          ...
          description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Senectus et netus et malesuada fames ac turpis egestas."
        },
      work: [{
          dateBegin: "Jan 2020",
          dateEnd: "March 2022",
...
// this class function determines which object in state to focus on, based on which button was clicked. allows me to share same function
 deleteEntry(id, name){
   name === "education" ? this.setState(prevValue => {
  ...
  render() {
    ...
    return (
      <div className="container">
          <Edit personal={general} onChange={this.handleChange} changeEducation={this.changeEducation} changeWork={this.changeWork} addEducation={this.addEducation} add={this.addExperience} deleteEntry={this.deleteEntry} education={education} work={work}/>
        <div className="generatedInfo">
       
          <Preview name={general.name}
                    job={general.job}
                    general={general}
                    education={education}
                    work={work}
